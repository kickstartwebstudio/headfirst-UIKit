    ...
    <div class="uk-container">
        <nav class="" uk-navbar>
            <div class="uk-navbar-left">
                <div class="uk-logo">Headfirst</div>
            </div>
...
<div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slideshow="animation: push">
    ...
    <ul class="uk-slideshow-items" uk-height-viewport="offset-bottom: 20">
        <li>
            <img src="https://source.unsplash.com/DH5183gvKUg/1600x900" alt="" uk-cover>
        ...
        <li>
            <img src="https://source.unsplash.com/sCdm5DiJb8w/1600x900" alt="" uk-cover>
            <div class="uk-position-center uk-position-small uk-text-center">
                <h2 uk-slideshow-parallax="x: 100,-100">Heading</h2>
                <p uk-slideshow-parallax="x: 200,-200">Lorem ipsum dolor sit amet.</p>
            </div>
